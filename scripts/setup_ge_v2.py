...
def setup_and_validate():
    ...
    # 1. 创建 Expectation Suite - 股票列表
    print("\n📋 创建股票列表期望套件...")
    suite_stock = ge.ExpectationSuite(name="stock_list_suite")
    ...
    # 2. 创建 Expectation Suite - K线数据
    print("\n📋 创建K线数据期望套件...")
    suite_kline = ge.ExpectationSuite(name="kline_data_suite")
    ...
    return suite_stock, suite_kline
