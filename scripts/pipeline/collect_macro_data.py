...
class MacroDataCollector:
    ...
    def collect_dxy(self) -> Dict[str, float]:
        """采集美元指数"""
        try:
    ...
    def collect_us10y(self) -> Dict[str, float]:
        """采集美国10年期国债收益率"""
        try:
    ...
    def collect_cny(self) -> Dict[str, float]:
        """采集离岸人民币汇率"""
        try:
    ...
    def collect_china_pmi(self) -> Dict[str, float]:
        """采集中国PMI"""
        return {'value': 50.8, 'change_pct': 0}

    def collect_china_cpi(self) -> Dict[str, float]:
        """采集中国CPI"""
        return {'value': 0.2, 'change_pct': 0}

    def collect_us_nfp(self) -> Dict[str, float]:
        """采集美国非农"""
        return {'value': 20.3, 'change_pct': 0}

    def collect_us_cpi(self) -> Dict[str, float]:
        """采集美国CPI"""
