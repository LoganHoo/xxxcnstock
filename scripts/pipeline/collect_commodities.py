...
class CommoditiesCollector:
    ...
    def collect_gold(self) -> Dict[str, float]:
        """采集黄金价格"""
        try:
    ...
    def collect_silver(self) -> Dict[str, float]:
        """采集白银价格"""
        try:
    ...
    def collect_copper(self) -> Dict[str, float]:
        """采集铜价格"""
        try:
    ...
    def collect_lithium(self) -> Dict[str, float]:
        """采集碳酸锂价格"""
